  ...
  return (
    <div className="relative py-12 overflow-hidden rounded-b-3xl">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <svg className="hidden md:block absolute bottom-8 right-1/4 w-20 h-8" viewBox="0 0 73 28" fill="none">
          <path d="M28.512 8.008C32.074 10.383 32.074 15.617 28.512 17.992L9.328 30.781C5.341 33.439 0 30.581 0 25.789L0 0.211C0 -4.581 5.341 -7.439 9.328 -4.781L28.512 8.008Z" fill="white" fillOpacity="0.6"/>
          <path d="M72.512 8.008C76.074 10.383 76.074 15.617 72.512 17.992L53.328 30.781C49.341 33.439 44 30.581 44 25.789L44 0.211C44 -4.581 49.341 -7.439 53.328 -4.781L72.512 8.008Z" fill="white" fillOpacity="0.6"/>
        </svg>
        
        <svg className="hidden md:block absolute top-16 left-1/4 w-20 h-8" viewBox="0 0 73 28" fill="none">
          <path d="M28.512 8.008C32.074 10.383 32.074 15.617 28.512 17.992L9.328 30.781C5.341 33.439 0 30.581 0 25.789L0 0.211C0 -4.581 5.341 -7.439 9.328 -4.781L28.512 8.008Z" fill="white" fillOpacity="0.6"/>
          <path d="M72.512 8.008C76.074 10.383 76.074 15.617 72.512 17.992L53.328 30.781C49.341 33.439 44 30.581 44 25.789L44 0.211C44 -4.581 49.341 -7.439 53.328 -4.781L72.512 8.008Z" fill="white" fillOpacity="0.6"/>
        </svg>
      </div>
